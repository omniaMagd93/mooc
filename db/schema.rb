...
ActiveRecord::Schema.define(version: 20180517215830) do
  ...
  create_table "lectures_users", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.bigint "lecture_id"
    t.bigint "user_id"
